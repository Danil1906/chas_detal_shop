...
urlpatterns = [
    ...
    path('category/<str:slug>/', DetailCategoryView.as_view(), name='category'),
    path('category/<str:slug>/<int:id>', DetailCategoryView.as_view(), name='product_notify'),
    path('product/review/<int:product_id>', product_review, name='product_review'),
    path('<slug:cslug>/<slug:slug>/', DetailProductView.as_view(), name='product'),
