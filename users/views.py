                ...
                if promo_form.is_valid():
                    ...
                    if promo.promo == code:
                        ...
                        messages.error(request,
                                       f'''Промокод не применен, статус оптовомго покупателя не был присвоен, возможно ошибка в написании
                                          промокода или же промокод более не активен.
                                          Для продолжения регистарции аккаунт как "розничного покупателя" перейдите на почту {email} и подтвердите адрес или
                                          попробуйте зарегистрироваться снова с переданным вам промокодом для того чтобы продолжить регистрацию "как оптовый" покупатель.''')
                        send_email_verify(request, user)
